...
import { GithubCloudAccess } from "./GithubCloudAccess";
import {
  ArrowUpRight,
  CheckCircle2,
  Loader2,
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-base">
          Connect GitHub on this computer and choose which repositories Deus Cloud can access.
        </p>
      </div>

      <h4 className="text-sm font-medium">On this computer</h4>
