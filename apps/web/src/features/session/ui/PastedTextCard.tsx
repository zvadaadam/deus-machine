...
export function PastedTextCard({ content, onRemove }: PastedTextCardProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onRemove}
        className="control-interaction bg-bg-elevated border-border/40 absolute -top-1.5 -right-1.5 flex h-5 w-5 items-center justify-center rounded-full border opacity-0 shadow-sm group-hover:opacity-100 before:absolute before:inset-[-12px] before:content-[''] focus-visible:opacity-100"
