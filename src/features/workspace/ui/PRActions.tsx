    ...
    <Tooltip delayDuration={200}>
      <TooltipTrigger asChild>
        <a
          ...
          className={cn(
            "flex items-center gap-1 rounded-md px-1.5 py-1 text-xs font-semibold transition-colors duration-200 ease",
...
function StatusText({
  ...
  return (
    <span
      className={cn(
        "flex h-[23px] items-center gap-1.5 rounded-md px-2.5 text-xs font-medium",
...
function ActionButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "flex h-[23px] items-center gap-1.5 rounded-md px-2.5 text-xs font-semibold transition-colors duration-200",
  ...
  return (
    <div className="flex h-[23px] overflow-hidden rounded-md">
      <button
        ...
        disabled={!onCreatePR}
        className={cn(
          "bg-primary flex items-center gap-1.5 rounded-l-md px-2.5 text-xs font-semibold transition-colors duration-200",
          !onCreatePR
      ...
      >
        <button
          type="button"
          className="bg-accent-blue-surface border-primary text-primary flex items-center gap-1 rounded-r-md border-l px-2 text-xs font-medium transition-colors duration-200 hover:opacity-90"
        >
