# 🚀 Running Conductor (BOX IDE)

This guide shows you how to run the Conductor application in development mode.
...
```
src-tauri/target/release/bundle/macos/Conductor.app
```
