 ...
 *
 * IMPORTANT: This is a copy of backend/src/lib/schema.ts.
 * The sidecar builds independently (esbuild) and cannot import from backend/.
 * When modifying schema, update BOTH files.
 */
