...
export function CodePanelContent({
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="border-border-subtle flex h-9 flex-shrink-0 items-center justify-between border-b px-4">
        <div className="flex items-center">
          <button
            type="button"
            onClick={() => onFilterModeChange?.("changes")}
            className={cn(
              "h-7 rounded-[5px] px-3 text-xs transition-colors duration-200 ease",
              filterMode === "changes"
