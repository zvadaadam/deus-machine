...
Conductor MCP tools for user interaction and workspace state inspection.
...
View all changes on the current branch (including uncommitted) compared against the merge base. Same diff shown in the Conductor UI and used for PRs.
