      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="control-interaction text-muted-foreground hover:text-foreground hover:bg-control-hover active:bg-control-pressed absolute top-3 right-3 flex size-7 items-center justify-center rounded-lg [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
