...
export function RightSidecar({ activeTab, onTabChange }: RightSidecarProps) {
  return (
    <div className="bg-background/60 border-border/40 flex h-full w-14 flex-shrink-0 flex-col items-center gap-2 border-l px-1.5 py-3 backdrop-blur-sm">
