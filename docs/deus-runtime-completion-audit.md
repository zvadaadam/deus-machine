...
- `bun run smoke:packaged-app`
- `bun run smoke:packaged-runtime`
- `bun run smoke:packaged-desktop`
...
```bash
bun run package:mac
bun run smoke:packaged-app -- --app <Deus.app> --require-gatekeeper
bun run smoke:packaged-runtime -- --app <Deus.app> --require-gatekeeper
bun run smoke:packaged-desktop -- --app <Deus.app> --require-gatekeeper
```
