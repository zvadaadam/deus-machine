...
import { INSPECT_MODE_SETUP, INSPECT_MODE_ENABLE, INSPECT_MODE_DISABLE } from "../automation/inspect-mode";
...
export const BrowserTab = forwardRef<BrowserTabHandle, BrowserTabProps>(
  function BrowserTab({ tab, devBrowserStatus, onUpdateTab, onAddLog, visible, onElementSelected }, ref) {
