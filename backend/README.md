...
Manages the SQLite connection to the OpenDevs database. Uses better-sqlite3 with WAL mode for better concurrency.
...
- Matches OpenDevs app architecture exactly
...
- Matches OpenDevs app architecture
...
3. **Consistency**: Matches OpenDevs app's architecture exactly
...
- All implementations match the OpenDevs sidecar exactly
...
- OpenDevs sidecar: `/Users/zvada/Documents/BOX/new-conductor/src-tauri/sidecar/index.bundled.js`
