...
function LandingPage() {
  return (
    <div className="bg-background text-foreground min-h-screen">
      ...
      {/* Main content — article centered, sidebar floats outside to the left */}
      <main className="relative mx-auto w-full max-w-[620px] px-6 py-12 md:py-16">
        {/* Sidebar — absolutely positioned to the left of centered content */}
        <aside className="absolute top-0 right-full bottom-0 hidden w-44 md:block">
          <div className="sticky top-0 flex h-screen flex-col py-10 pr-8">
        ...
        <section id="overview" className="mb-24">
          ...
          <p className="text-muted-foreground mt-5 max-w-[54ch] text-[15px] leading-[1.7]">
            You spend 80% of your time being a human clipboard between tools that should be talking
            to each other. Deus closes the loop. Plan the work, approve the plan, walk away. Come
            back to software.
          </p>
        ...
        <section id="the-problem" className="mb-24">
          ...
          <div className="text-muted-foreground mt-4 max-w-[54ch] space-y-4 text-[15px] leading-[1.7]">
            <p>
              Coding agents are brilliant inside a terminal and blind outside of it. They write code
              that would take you hours, but they can't see what they built. Can't click a button.
              Can't run the tests and react to what happens.
            </p>
            <p>
              So you sit there closing the loop manually. Copy the error. Paste it back. Agent fixes
              it. Check again. Open the browser. Screenshot. Paste. Fix. Check. Create a PR. Wait
              for CI. It's red. Copy the logs. Paste. Fix. CI again.
            </p>
            ...
            {[
              ...
              <li key={i} className="flex gap-4">
                ...
                <span className="text-muted-foreground text-[15px] leading-[1.7]">
                  <strong className="text-foreground font-medium">{step.title}</strong> {step.text}
                </span>
              </li>
            ))}
          </ol>
        ...
        <section id="install" className="mb-16">
          ...
          <p className="text-muted-foreground mt-4 max-w-[54ch] text-[15px] leading-[1.7]">
            Open source. Runs on your hardware. Your agents, your data, your machine. Download the
            app or build from source — the box is yours to rebuild.
          </p>
