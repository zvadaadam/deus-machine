  ...
  return (
    ...
    >
      <div
        tabIndex={0}
        className={cn(
          "relative flex cursor-pointer items-center gap-1.5 py-[3px] pr-3 text-[12px]",
      ...
      >
        ...
        {!isDirectory && (node.additions || node.deletions) && (
          <div className="flex items-center gap-1 font-mono text-[10px] tabular-nums opacity-60">
